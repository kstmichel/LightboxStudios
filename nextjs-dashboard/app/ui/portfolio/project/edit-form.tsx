...
import { Skill, Project } from '@/app/lib/definitions';
...
export default function Form({ project, skills }: { project: Project, skills: Skill[] }) {
  ...
  const [selectedSkills, setSelectedSkills] = React.useState<Skill[]>(project.skills || []);
  ...
  const handleSkillsSelect = (event: React.SyntheticEvent<Element, Event>, value: Skill[]) => {
    ...
    console.log('test', selectedSkills.map(skill => skill.id).toString());
      ...
      <form action={formAction}>
        ...
        <div className="mb-4 grid">
          <FormControl fullWidth className="mb-6">
            ...
            <TextField type="text" defaultValue={project.title} id="title" name="title" required />
          ...
          <FormControl fullWidth className="mb-6">
            ...
            <TextareaAutosize  
                ...
                id="description" defaultValue={project.description} name="description" maxRows={677} required/>
          ...
          <FormControl fullWidth className="mb-6">
            ...
            <TextField type="text" id="image_url" name="image_url" defaultValue={project.image_url} required />
{/* 
          ...
          <FormControl fullWidth className="mb-6">
            ...
            <TextField type="text" id="alt" name="alt" defaultValue={project.alt} required/>
          </FormControl>
            ...
            <div className="flex flex-wrap flex-col w-full">
              <div id="search-skill">
                ...
                <Autocomplete 
                    ...
                    renderInput={(params) => <TextField {...params} id="skillsField" name="skillsField" className="mb-3" />} />
                    <input type="hidden" name="skills" value={selectedSkills.map(skill => skill.id)} />
              </div>
              {/* <div id="add-skill">
